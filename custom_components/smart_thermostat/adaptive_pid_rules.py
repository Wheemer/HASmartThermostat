...
from .adaptive_pid_constants import (
...
class PIDRule(Enum):
    ...
    CHRONIC_APPROACH_FAILURE = ("chronic_approach_failure", RULE_PRIORITY_SLOW_RESPONSE)
...
def evaluate_pid_rules(
    ...
    """
    from .adaptive_pid_constants import MIN_OUTDOOR_TEMP_RANGE, SLOW_RESPONSE_CORRELATION_THRESHOLD
